!function(t, e) {
    ...
    , function(t, e, i) {
        ...
        const r = i(10)
          ...
          , o = t => ({
            "price.display.poiPrice": t.isOptionalObject,
            "price.display.poiPrice.value": e => t.isNumber && 0 !== e,
            "price.display.poiPrice.display": t.isOptionalObject,
            "price.display.poiPrice.display.smart": t.isOptionalString,
            "price.display.poiPrice.display.actual": t.isOptionalString,
            "price.display.poiPrice.display.from": t.isOptionalString,
            "price.display.poiPrice.display.perMonthValue": t.isOptionalString,
            "price.display.poiPrice.display.months": t.isOptionalString,
            "price.display.poiPrice.display.apr": t.isOptionalString,
            "price.display.poiPrice.display.perMonth": t.isOptionalString,
            "price.display.poiPrice.display.perMonthSmart": t.isOptionalString,
            "price.display.poiPrice.display.perMonthActual": t.isOptionalString,
            "price.display.poiPrice.display.monthlyFrom": t.isOptionalString,
            "price.display.poiPrice.display.monthlyPrice": t.isOptionalString
        })
          , c = t => ({
    ...
    , function(t, e, i) {
        ...
        const n = {
            ...
            isOptionalString: t => null == t || "string" == typeof t,
            isNumber: t => "number" == typeof t,
            isObject: t => "[object Object]" === Object.prototype.toString.call(t),
            isOptionalObject: t => null == t || "[object Object]" === Object.prototype.toString.call(t),
            isOptionalBoolean: t => "boolean" == typeof t || null == t
        }
          , a = new Set([n.isOptionalString, n.isOptionalObject, n.isOptionalBoolean]);
        function o(t, e) {
        ...
        t.exports = function(t, e) {
            ...
            for (let e = 0, s = i.length; e < s; e++) {
                const [s,n] = i[e]
                  , c = s.indexOf(".") > -1 ? o(t, s) : t[s];
                if (!0 !== n.call(t, c, t)) {
                    if (a.has(n)) {
                        r.warn(`Optional schema property "${s}" has an invalid type.`);
                        continue
                    }
                    return r.error(`Schema property "${s}" does not match response.`),
                    !1
                }
            }
            return !0
    ...
    , function(t, e, i) {
        ...
        t.exports = class extends n {
            ...
            formatResponseItem(t, e) {
                let i = null;
                if (this.options.dummyPrices && "UNKNOWN" === e.type && (e = r(t, "unknown"),
                this.itemsWithDummyPrice.push(t)),
                i = new s(e),
                !i.price || 0 !== i.price.value)
                    return i.price && 999999 === i.price.value && this.itemsWithDummyPrice.push(t),
                    i
            }
    ...
    , function(t, e, i) {
        ...
        t.exports = class {
            ...
            loggData(t) {
                ...
                n.log(t),
                n.groupEnd(),
                n.enabled && this.itemsWithDummyPrice.length && (n.group("Dummy Prices"),
                n.warn("Using dummy prices for the following product identifiers: " + this.itemsWithDummyPrice.join(", ")),
                n.info("$777,777 — The API service may require authentication and/or authorization. \n$888,888 — The product identifer is currently unknown to the API service. \n$999,999 — The product identifier is known to the API service, but the price has yet to be set. \n$111,111 — The referenced optional field was not provided in the API response. \n"),
                n.groupEnd())
            }
            ...
            _handleError(t) {
                ...
                return t && "function" == typeof t.showHint && t.showHint(i.products),
                i
            }
            _maybeForceError() {
            ...
            _processOptions(t) {
                ...
                return e.length && (this.identifierToAliasMap = e.reduce( (t, [e,i]) => (t[i] = t[i] || [],
                t[i].push(e),
                t), {}),
            ...
            _processResponse(t) {
                ...
                case 200:
                    if (i = a(t.responseText),
                    null !== i && (e = this.getItemsFromResponse(i),
                    e))
                        return e;
                default:
    ...
    , function(t, e, i) {
        ...
        const r = i(4)
          ...
          , d = "Hide"
          , m = "HideAll"
          , f = "MultipleElementsToHide"
          , b = "Product"
          , g = "SingleElementsToHide"
          , _ = {
            isOptionalString: Symbol("OPTIONAL_STRING"),
            isOptionalBoolean: Symbol("OPTIONAL_BOOLEAN")
        }
          , y = new Set(Object.values(_))
          , x = new Map([[_.isOptionalString, t => "string" == typeof t], [_.isOptionalBoolean, t => "boolean" == typeof t]]);
        function F(t) {
            const e = new Set
              , i = new Map;
        ...
        t.exports = new class {
            ...
            fetchProductInfo(t, e={}) {
                let i, r;
                const s = this.getProductID(t, this[`${t}${p}`]);
                return l(t).then(n => {
                    const a = Object.assign({}, n, e);
                    return t === I ? r = c(s, e) : t === E ? r = o(s, e) : t === C ? r = u(s, e) : i = "API not supported",
                    i || r.then(t => ({
                        response: t,
                        options: a
                    }))
            ...
            getRawValueAtPath(t, e) {
                return t.split(".").reduce( (t, e) => null == t ? void 0 : t[e], e)
            }
            getOptionalFields(t) {
                return t === C ? v : w
            }
            getOptionalFieldChecks(t) {
                return t === C ? A : O
            }
            isMalformedOptional(t, e, i, r) {
                if (!i.has(t))
                    return !1;
                const s = this.getRawValueAtPath(t, e)
                  , n = r.get(t);
                return null != s && !!n && !n(s)
            }
            getproductID(t, e) {
                return t.dataset[`${e}${b}`]
            }
            ...
            hideMultipleElements(t, e) {
                this[`${e}${f}`].forEach(i => {
                    const r = i.dataset[`${e}${m}`].split(",").every(e => !t.products[e] || this.checkForProductNameKey(t.products[e], t.products[e].productName) || this.checkForTypeKey(t.products[e], t.products[e].type));
            ...
            handleProductInfo(t, e, i, r) {
                ...
                if (i.error && (!r.dummyPrices || !s.price))
                    return this.handleError(e, i, t);
                const n = e.dataset.productTemplate || "";
                let a = !1;
                const o = this.getOptionalFields(t)
                  , c = this.getOptionalFieldChecks(t)
                  , u = Object.values(h)
                  , l = s.price && s.price.value || s.credit && s.credit.value
                  , p = null != l && (u.includes(l) || 999999 === l)
                  , d = n.replace(/\$\{\s*([\w\d.]+)\s*\}/g, (t, e) => {
                    if (this.isMalformedOptional(e, s, o, c))
                        return a = !0,
                        "";
                    const i = this.getValueFromPath(t, s);
                    return i || (r.dummyPrices && o.has(e) ? p ? (a = !0,
                    "") : "$111,111" : (a = !0,
                    ""))
                }
                );
            ...
            fetchProductDataFromHTML(t, e) {
                return new Promise(i => {
                    ...
                    this.fetchProductInfo(t, e).then( ({response: e, options: r}) => {
                        e && (this[`${t}${p}`].forEach(i => this.handleProductInfo(t, i, e, r)),
                        i(e.error))
                    }
                    ).catch(t => {
                        throw t
            ...
            loadPricingFromHTML(t) {
                return this.fetchProductDataFromHTML(I, t)
            }
            loadTradeInFromHTML(t) {
                return this.fetchProductDataFromHTML(C, t)
            }
        }
    }
    , function(t, e, i) {
    ...
    , function(t, e, i) {
        "use strict";
        var r, s = i(51).EventEmitterMicro, n = i(52), a = i(55);
        function o(t) {
            t = t || {},
            s.call(this),
            this.id = a.getNewID(),
    ...
    , function(t, e, i) {
        "use strict";
        var r = i(15).SharedInstance
          , s = i(16).majorVersionNumber
          , n = i(54);
        t.exports = r.share("@marcom/ac-raf-emitter/sharedRAFExecutorInstance", s, n)
    }
    , function(t, e, i) {
        "use strict";
        var r, s = window, n = s.AC, a = (r = {},
        {
            get: function(t, e) {
                var i = null;
            ...
            return {
                ...
                price: {
                    ...
                    display: {
                        ...
                        smart: "$" + a,
                        from: "From $" + a,
                        disclaimer: "Mock disclaimer text.",
                        legal: "Mock legal text.",
                        monthlyFrom: "From $" + a + "/mo.",
                        monthlyFromLegal: "From $" + a + "/mo. for 24 mo.",
                        ...
                        coveragePrice: "$" + a,
                        coverageTerm: "24 mo.",
                        carrierDiscountLegal: "Price includes a $" + a + " AT&T, T-Mobile, or Verizon discount. Requires activation with carrier.",
                        poiPrice: {
                            value: n,
                            display: {
                                actual: c,
    ...
    , function(t, e, i) {
        ...
        t.exports = function(t, e, i=[]) {
            ...
            if (a)
                ...
                for (const t of i)
                    u(t);
            const l = ((t = t.replace(n, "")).match(s) || [])[1];
            let h = t;
            if (i.length) {
                const t = ( (t, e, i) => {
    ...
    , function(t, e, i) {
        ...
        t.exports = function(t=[]) {
            ...
            t.filter(t => "string" == typeof t).map(t => encodeURIComponent(String(t).trim())).join(",")
        }
    }
    , function(t, e, i) {
        "use strict";
    ...
    , function(t, e, i) {
        ...
        t.exports = class extends Error {
            ...
            showHint() {
                "endpoint" === this.type && (r.warn(this.message + " This may be expected if this page's locale doesn't have an Apple Online Store."),
                r.info('If prices are expected for this locale, check that the API service endpoint is specified in HTML with %c<link rel="ac:pricing-endpoint" href="/path/to/endpoint">%c or the "fetchProducts" function\'s "endpoint" option.', "font-family:monospace", ""))
            }
        }
    }
    , function(t, e, i) {
    ...
    , function(t, e, i) {
        ...
        t.exports = class extends s {
            ...
            formatResponseItem(t, e) {
                let i = null;
                if (this.options.dummyPrices && "UNKNOWN" === e.productName && (e = r(t, "unknown"),
                this.itemsWithDummyPrice.push(t)),
                i = new n(e),
                !i.credit || 0 !== i.credit.value)
                    return i.credit && 999999 === i.credit.value && this.itemsWithDummyPrice.push(t),
                    i
            }
            getItemsFromResponse(t) {
                return t.ids
